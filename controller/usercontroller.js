...
exports.userloginpage = (req, res) => {
   ...
   res.render("user/login", { loginerror: req.session.loginerr });
    req.session.loginerr = false;
      ...
      console.log(err,'error happened in userloginpage');
    res.redirect('/404')
    }
   }
...
let bannerimage=await Banner.find()
  ...
  console.log('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',offercategories);
  if (req.session.userlogin) {
    ...
    res.render("user/home", {
      ...
      cartcount,
      newproducts,bannerimage,offercategories,cartdetails
    });
  } else {
    res.render("user/home", {
      isuser: req.session.userlogin,
